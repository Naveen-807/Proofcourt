...
const PIECES: WorkflowPiece[] = [
  ...
  { id: 'strategy', label: 'Strategy Agent', desc: 'Watches trigger and hires', category: 'Agents', icon: Bot, badge: 'Selected' },
  { id: 'executor', label: 'Executor Agent', desc: 'Performs protected work', category: 'Agents', icon: Bot, badge: 'Score 89' },
  { id: 'judge', label: 'Proof Judge Agent', desc: 'Approves permits', category: 'Agents', icon: Scale, badge: 'System' },
